...
// Images
import topBanner from '../../../Assets/Images/services/images/AlloyWheelPolish.jpg'
...
const AlloyWheelPolish = () => {

  // SEO Tags
  useEffect(() => {
    document.title = 'Alloy Wheel Polish | Services - Würth CAR-Haus';
  ...
  return (
    <div>
        ...
        <section className='topBanner'>
            ...
            <div className='topBannerText'>
                <div className='container'>
                    <h1 className='sizeH1 tu white'>Alloy Wheel Polish</h1>
                </div>
            </div>
        </section>
        ...
        <div className='breadcrumbNav'>
            ...
            <Link className='active'>Alloy Wheel Polish</Link>
            </div>
            </div>
        </div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol' data-aos="fade-up">
              <h3 className='sizeH2 red '><span className="tu">Alloy Wheel Polish</span></h3>
            </div>
            <div className='aboutDataCol'>
              <h4><b>Keep your wheels shining like new</b> </h4>
              <p><b>Revive the lustre of your car's wheels and keep them looking brand new with Alloy Wheel Polish.</b> </p>
            </div>
...
<div className='clickBoxCol white'>
  ...
  <p><b>01.</b>Restores Original Shine: Say goodbye to dull, tarnished wheels. Our Alloy Wheel Polish brings back the original shine and brilliance.</p>
  <p><b>02.</b>Enhances Vehicle Appearance: Your wheels are a reflection of your car's overall look. With a polished finish, your vehicle exudes class and style.</p>
  <p><b>03.</b>Protection Against Corrosion: Alloy Wheel Polish forms a protective barrier against corrosion, extending the life of your wheels.</p>
  <p><b>04.</b>Easier Maintenance: Polished wheels are easier to clean and maintain, saving you time and effort.</p>
...
export default AlloyWheelPolish