...
// Images
import topBanner from '../../../Assets/Images/services/images/EmblemCleaning.jpg'
...
const EmblemCleaning = () => {

  // SEO Tags
  useEffect(() => {
    document.title = 'Emblem Cleaning | Services - Würth CAR-Haus';
  ...
  return (
    <div>
        ...
        <section className='topBanner'>
            ...
            <div className='topBannerText'>
                <div className='container'>
                    <h1 className='sizeH1 tu white'>Emblem Cleaning</h1>
                </div>
            </div>
        </section>
        ...
        <div className='breadcrumbNav'>
            ...
            <Link className='active'>Emblem Cleaning</Link>
            </div>
            </div>
        </div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol' data-aos="fade-up">
              <h3 className='sizeH2 red '><span className="tu">Emblem Cleaning</span></h3>
            </div>
            <div className='aboutDataCol'>
              <h4><b>Restore your car's emblem to its former glory</b> </h4>
              <p><b>Restore your vehicle's emblem with our Emblem Cleaning service</b> </p>
            </div>
...
<div className='clickBoxCol white'>
  ...
  <p><b>01.</b>Rekindles Emblem Shine: Say goodbye to tarnished emblems as we restore their shine and lustre with Emblem Cleaning.</p>
  <p><b>02.</b>Enhances Aesthetic Appeal: Elevate your car's overall look by ensuring its emblem looks as good as new.</p>
  <p><b>03.</b>Preserves Brand Identity: Maintain the authenticity and identity of your vehicle's emblem for a lasting impression.</p>
