    ...
    <div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol'>
              <h4><b>Keep your car's heart running strong</b> </h4>
              <p><b>Shield your engine from the elements and extend its lifespan with Engine Coat</b> </p>
            </div>
...
<div className='clickBoxCol white'>
  ...
  <p><b>01.</b>Enhanced Durability: Say goodbye to premature wear and tear, as Engine Coat helps your engine stay strong.</p>
  <p><b>02.</b>Improved Performance: Ensure optimal engine performance by protecting it from dirt, dust, and corrosion.</p>
  <p><b>03.</b>Longevity Guaranteed: Extend the life of your vehicle's engine, reducing the need for costly repairs.</p>
