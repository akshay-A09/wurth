...
const WindshieldPolish = () => {
  ...
  const ppfItemsData = [
    { 
      image: CarRevives,
      tital: "Clarity in Every Drive", 
      description: "Say goodbye to hazy, obstructed views with our windshield polish." 
    },
    { 
      image: Maintenance,
      tital: 'Safety Assurance', 
      description: "Ensure a safer driving experience with a crystal-clear windshield." 
    },
    { 
      image: Redefine,
      tital: 'Preserves Aesthetic Appeal', 
      description: "Enhance your vehicle's appearance while safeguarding your view." 
    }
    ...
    <div>
        ...
        <section className='topBanner'>
            <div className='topBannerImg'>
                <img src={topBanner} alt='Windshield Polish'/>
            </div>
