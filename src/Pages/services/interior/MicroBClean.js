...
// Images
import topBanner from '../../../Assets/Images/services/new/MicroBClean.jpg'
...
const MicroBClean = () => {
  ...
  // SEO Tags
  useEffect(() => {
    document.title = 'Micro B Clean | Services - Würth CAR-Haus';
  ...
  return (
    <div>
        ...
        <section className='topBanner'>
            ...
            <div className='topBannerText'>
                <div className='container'>
                    <h1 className='sizeH1 tu white'>Micro B Clean</h1>
                </div>
            </div>
        </section>
        ...
        <div className='breadcrumbNav'>
            ...
            <Link>Interior</Link>
            <Link className='active'>Micro B Clean</Link>
            </div>
            </div>
        </div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol' data-aos="fade-up">
              <h3 className='sizeH2 red '><span className="tu">Micro B Clean</span></h3>
            </div>
