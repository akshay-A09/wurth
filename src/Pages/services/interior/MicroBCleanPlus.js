...
const MicroBCleanPlus = () => {

  // SEO Tags
  useEffect(() => {
    document.title = 'Micro B Clean Plus | Services - Würth CAR-Haus';
  ...
  return (
    <div>
        ...
        <section className='topBanner'>
            ...
            <div className='topBannerText'>
                <div className='container'>
                    <h1 className='sizeH1 tu white'>Micro B Clean Plus</h1>
                </div>
            </div>
        </section>
        ...
        <div className='breadcrumbNav'>
            ...
            <Link>Interior</Link>
            <Link className='active'>Micro B Clean Plus</Link>
            </div>
            </div>
        </div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol' data-aos="fade-up">
              <h3 className='sizeH2 red '><span className="tu">Micro B Clean Plus</span></h3>
            </div>
...
export default MicroBCleanPlus
