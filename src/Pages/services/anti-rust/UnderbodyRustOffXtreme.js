...
// Images
import topBanner from '../../../Assets/Images/services/new/UnderbodyRustOffXtreme.jpg'
...
const UnderbodyRustOffXtreme = () => {

  // SEO Tags
  useEffect(() => {
    document.title = 'Underbody Rust Off X-treme | Services - Würth CAR-Haus';
  ...
  return (
    <div>
        ...
        <section className='topBanner'>
            ...
            <div className='topBannerText'>
                <div className='container'>
                    <h1 className='sizeH1 tu white'>Underbody Rust <br/> Off X-treme</h1>
                </div>
            </div>
        </section>
        ...
        <div className='breadcrumbNav'>
            ...
            <Link>Anti Rust</Link>
            <Link className='active'>Underbody Rust Off X-treme</Link>
            </div>
            </div>
        </div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol' data-aos="fade-up">
              <h3 className='sizeH2 red '><span className="tu">Underbody Rust Off X-treme
</span></h3>
            </div>
...
<h3 className='sizeH4'>Underbody Rust Off X-treme - 5 years</h3>
<img src={ceraMaxx} />
...
export default UnderbodyRustOffXtreme
