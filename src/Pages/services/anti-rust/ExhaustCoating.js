...
// Images
import topBanner from '../../../Assets/Images/services/new/ExaustCoating.jpg'
...
const ExhaustCoating = () => {

  // SEO Tags
  useEffect(() => {
    document.title = 'Exhaust Coating | Services - Würth CAR-Haus';
  ...
  return (
    <div>
        ...
        <section className='topBanner'>
            ...
            <div className='topBannerText'>
                <div className='container'>
                    <h1 className='sizeH1 tu white'>Exhaust Coating</h1>
                </div>
            </div>
        </section>
        ...
        <div className='breadcrumbNav'>
            ...
            <Link>Anti Rust</Link>
            <Link className='active'>Exhaust Coating</Link>
            </div>
            </div>
        </div>
        ...
        <div className='container'>
            ...
            <div className='aboutDataCol' data-aos="fade-up">
              <h3 className='sizeH2 red '><span className="tu">Exhaust Coating</span></h3>
            </div>
            <div className='aboutDataCol'>
              <h4><b>Keep your exhaust system pristine</b> </h4>
              <p><b>Shield your exhaust system from the elements with Exhaust Coating</b> </p>
            </div>
...
<div className='clickBoxCol white'>
  ...
  <p><b>01.</b>Enhanced Longevity: Extend the life of your exhaust system by safeguarding it from corrosive elements.</p>
  <p><b>02.</b>Preserve Performance: Maintain optimal exhaust system performance with our advanced coating.</p>
  <p><b>03.</b>Simplified Maintenance: Coated exhausts are easier to clean and require less upkeep.</p>
  <p><b>04.</b>Invest in your car's health with Exhaust Coating and ensure it runs smoothly for years to come.</p>
