...
const ExhaustCoating = () => {
  ...
  const ppfItemsData = [
    { 
      image: Redefine,
      tital: "Enhanced Longevity", 
      description: "Extend the life of your exhaust system by safeguarding it from corrosive elements." 
    },
    { 
      image: Maintenance,
      tital: 'Preserve Performance', 
      description: "Maintain optimal exhaust system performance with our advanced coating." 
    },
    { 
      image: Esay,
      tital: 'Simplified Maintenance', 
      description: 'Coated exhausts are easier to clean and require less upkeep.' 
    }
